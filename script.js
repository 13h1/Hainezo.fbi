...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const startMessage = " Wanna see the truth ?";
  ...
  homeButton.addEventListener('click', () => {
    switchTheme('assets/back.mp4', backgroundMusic, 'home-theme');
  });
  ...
  hackerButton.addEventListener('click', () => {
    switchTheme('assets/chill.mp4', hackerMusic, 'hacker-theme', hackerOverlay, false);
  });
  ...
  rainButton.addEventListener('click', () => {
    switchTheme('assets/rain.mp4', rainMusic, 'rain-theme', snowOverlay, true);
  });
  ...
  animeButton.addEventListener('click', () => {
    switchTheme('assets/waves.mp4', animeMusic, 'anime-theme');
  });
  ...
  carButton.addEventListener('click', () => {
    switchTheme('assets/city.mp4', carMusic, 'car-theme');
  });
    ...
    if (!isShowingSkills) {
      gsap.to(profileBlock, {
        ...
        onComplete: () => {
          ...
          gsap.to(pythonBar, { width: '65%', duration: 2, ease: 'power2.out' });
          gsap.to(cppBar, { width: '88%', duration: 2, ease: 'power2.out' });
          gsap.to(csharpBar, { width: '35%', duration: 2, ease: 'power2.out' });
        }
      });
